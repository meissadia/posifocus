        ...
        <BrowserRouter>
          <AppFrame logo="/images/posifocus-logo.png" altText="Posifocus Logo">
            ...
            <Route exact path='/gratitudes' render={() => (
                <Gratitudes data={this.state.gratitudes}
            ...
            <Route exact path='/priorities' render={() => (
                <Priorities data={this.state.priorities}
                  handleDelete={this.deleteFromStateArray} />
              )}
              />
            ...
            />
          <Route exact path='/priority/:priority_id/project/:project_id/tasks' render={({match}) => {
          ...
          <Route exact path='/relationships' render={() => (
              <Relationships data={this.state.relationships}
                handleDelete={this.deleteFromStateArray}
                />
            )}
            />
          ...
          <Route exact path='/relationship/:relationship_id/contacts'
            render={ ({match}) => {
              ...
              (r.id == match.params.relationship_id))[0];

              let contacts = this.state.contacts &&
              this.state.contacts.filter((c) => (c.relationship === relationship.id.toString()));
          ...
          <Route path='/tasks/today' render={() => (
              <TodaysTasks data={this.state.tasks}
                handleDelete={this.deleteFromStateArray}
                />
            )}
            />
