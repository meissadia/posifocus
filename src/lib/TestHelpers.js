...
export const InitTestState = {
  userHeader: { user_name: '', user_image: '', user_tagline: '' },
  style: { background: '' },
  gratitudes: [
    {
      id: '1558164208892',
  ...
  priorities: [
    {
      id: '1558164208966',
      title: 'title',
      date: 'Sat May 18 2019 01:23:28 GMT-0600 (Mountain Daylight Time)'
    }
  ],
  projects: [
    {
      id: '1558164209070',
      priority: '1558164208966',
      title: 'title',
      date: 'Sat May 18 2019 01:23:29 GMT-0600 (Mountain Daylight Time)'
    }
  ],
  tasks: [
    {
